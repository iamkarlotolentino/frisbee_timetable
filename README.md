...
2. The lecture room or laboratories must be able to accomodate all students in a section.
3. A subject must not be taught in a single day.
4. A student can only attend one subject at a time.
5. Classes should be start within at 7AM till 6PM.

##### SOFT CONSTRAINTS:
1. Lunch time should within 10AM-12PM.
2. Classes' timeframe should be compact and centered in between 7AM - 6PM.
3. A break for every two consecutive lectures/laboratories.
-----------
###### Database Schema
![Database Schema](https://raw.githubusercontent.com/iamkarlotolentino/frisbee-comsoc/master/docs/schema.png?token=ALHOUF7AABNVPK2TKA6F4RS52VCRW)
------------



Developed by: Tolentino, Jan Carlo
